                          ...
                          <tr key={idx} className="hover:bg-blue-50/50 dark:hover:bg-gray-700/50 transition-colors">
                            ...
                            <td className="px-5 py-4 text-center">
                              {hasNotes ? (
                                ...
                                <div className="w-8 h-8 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center mx-auto opacity-30" title="لا توجد ملاحظات">
                                  📝
                                </div>
                              )}
                            </td>
